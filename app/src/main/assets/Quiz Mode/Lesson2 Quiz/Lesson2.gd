...
var lose_scene = preload("res://Quiz Mode/popup scene/lose_popup2.tscn")
var win_scene = preload("res://Quiz Mode/popup scene/win_popup2.tscn")
var fireball_scene = preload("res://Quiz Mode/Lesson2 Quiz/fireball2.tscn")
var virusfireball_scene = preload("res://Quiz Mode/Lesson2 Quiz/virusfireball2.tscn")
...
var questions := [
	{"text": "What is a variable?", "answers": ["A method", "A loop", "Data storage", "An operator"], "correct": 2},
	{"text": "Which keyword declares an integer variable?", "answers": ["char", "float", "String", "int"], "correct": 3},
	{"text": "Which data type is used for true or false?", "answers": ["char", "float", "int", "boolean"], "correct": 3},
	{"text": "Which data type stores decimal numbers?", "answers": ["char", "double", "int", "boolean"], "correct": 1},
	{"text": "Which data type stores text?", "answers": ["float", "String", "int", "boolean"], "correct": 1},
	{"text": "What keyword is used to make a constant?", "answers": ["static", "const", "perm", "final"], "correct": 3},
	{"text": "What is the size of an int?", "answers": ["8 bytes", "2 bytes", "1 byte", "4 bytes"], "correct": 3},
	{"text": "Which symbol assigns values?", "answers": ["=", "::", ":", "=="], "correct": 0},
	{"text": "Which is a valid variable name?", "answers": ["public", "value!", "myValue", "2value"], "correct": 2},
	{"text": "What does casting mean?", "answers": ["Change type", "Print output", "Debug code", "Declare var"], "correct": 0},
	{"text": "Which data type is for a single character?", "answers": ["int", "char", "float", "String"], "correct": 1},
	{"text": "Which keyword shows variable scope?", "answers": ["static", "main", "global", "public"], "correct": 3},
	{"text": "What will 'int age = 20;' do?", "answers": ["Display 20", "Store 20 as int", "Make constant", "Store 20 text"], "correct": 1},
	{"text": "Which operator increases a value by 1?", "answers": ["+=", "++", "=", "+"], "correct": 1},
	{"text": "What happens if a variable is not initialized?", "answers": ["Zero", "No value", "Runs fine", "Causes output"], "correct": 1}
]
...
func correct():
	...
	if not quiz_finished:
		player_sprite.play("IDLE2")

func wrong():
	if wrong_sound: wrong_sound.play()
	monster_sprite.play("ATTACKm2")
	await get_tree().create_timer(0.25).timeout
	shoot_virus()
	await get_tree().create_timer(1.5).timeout
	if not quiz_finished:
		monster_sprite.play("IDLEm2")
...
func hit_monster():
	...
	monster_sprite.play("HITm2")
	flash(monster_sprite)
	await get_tree().create_timer(0.5).timeout
	
	if GameState.virus_health <= 0:
		monster_sprite.play("DEADm2")
