...
var lose_scene = preload("res://Quiz Mode/popup scene/lose_popup6.tscn")
var win_scene = preload("res://Quiz Mode/popup scene/win_popup6.tscn")
var fireball_scene = preload("res://Quiz Mode/Lesson6 quiz/fireball6.tscn")
var virusfireball_scene = preload("res://Quiz Mode/Lesson6 quiz/virusfireball6.tscn")
...
var questions := [
 	{"text": "What is an array?", "answers": ["Single var", "Group of same type", "Random value", "Object class"], "correct": 1},
	{"text": "How do you declare an int array?", "answers": ["int[] arr;", "arr[] int;", "array int;", "int arr();"], "correct": 0},
	{"text": "What is the first index of an array?", "answers": ["1", "0", "-1", "2"], "correct": 1},
	{"text": "Which symbol accesses array elements?", "answers": ["[]", "{}", "()", "<>"], "correct": 0},
	{"text": "What happens if you access out of range?", "answers": ["Error", "Null", "Zero", "Skip"], "correct": 0},
	{"text": "How do you get array length?", "answers": ["arr.len", "arr.size()", "arr.length", "arr.count"], "correct": 2},
	{"text": "Which loop is best for arrays?", "answers": ["if", "switch", "for", "do-while"], "correct": 2},
	{"text": "What type of data can arrays store?", "answers": ["Same type", "Any type", "Mixed", "Only strings"], "correct": 0},
	{"text": "Which array initialization is correct?", "answers": ["int a[] = {1,2,3};", "int a = [1,2,3];", "int a(1,2,3);", "int a{1,2,3};"], "correct": 0},
	{"text": "What will arr[2] return in int[] arr = {4,5,6};?", "answers": ["4", "5", "6", "2"], "correct": 2},
	{"text": "What does arr.length - 1 represent?", "answers": ["Middle", "Last index", "First index", "Size"], "correct": 1},
	{"text": "Can arrays hold objects?", "answers": ["No", "Yes", "Only int", "Only String"], "correct": 1},
	{"text": "Which loop reads all array values easily?", "answers": ["for-each", "while", "switch", "if"], "correct": 0},
	{"text": "What is a multidimensional array?", "answers": ["Array in array", "Single array", "Loop var", "Object"], "correct": 0},
	{"text": "How do you declare 2D int array?", "answers": ["int[][] a;", "int[] a[];", "int a[][];", "All correct"], "correct": 3}
]

func _ready():
	print("🎮 LESSON 6 STARTING")
...
func show_instructions_popup():
	print("🎮 Showing instructions popup...")
	var popup_instance = popup_scene.instantiate()
	print("✅ Popup instance created")
	add_child(popup_instance)
	print("✅ Popup added to scene")
...
func show_q():
	print("🎮 show_q() called, current_q:", current_q, "questions.size():", questions.size())
...
func correct():
	...
	player_sprite.play("ATTACK6")
	await get_tree().create_timer(0.3).timeout
	shoot_fireball()
	await get_tree().create_timer(1.5).timeout
	if not quiz_finished:
		player_sprite.play("IDLE6")

func wrong():
	if wrong_sound: wrong_sound.play()
	monster_sprite.play("ATTACKm6")
	await get_tree().create_timer(0.25).timeout
	shoot_virus()
	await get_tree().create_timer(1.5).timeout
	if not quiz_finished:
		monster_sprite.play("IDLEm6")
...
func hit_monster():
	...
	monster_sprite.play("HITm6")
	flash(monster_sprite)
	await get_tree().create_timer(0.5).timeout
	
	if GameState.virus_health <= 0:
		monster_sprite.play("DEADm6")
