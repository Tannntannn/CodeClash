...
var lose_scene = preload("res://Quiz Mode/popup scene/lose_popup1.tscn")
var win_scene = preload("res://Quiz Mode/popup scene/win_popup1.tscn")
var fireball_scene = preload("res://Quiz Mode/Lesson1 Quiz/fireball1.tscn")
var virusfireball_scene = preload("res://Quiz Mode/Lesson1 Quiz/virusfireball1.tscn")
...
var questions := [
	{"text": "What is Java mainly used for?", "answers": ["Word tools", "Web & mobile apps", "Game consoles", "Operating systems"], "correct": 1},
	{"text": "Who originally developed Java?", "answers": ["Microsoft", "Apple", "Sun Microsystems", "Google"], "correct": 2},
	{"text": "What does WORA stand for?", "answers": ["Work Once Run Anytime", "Write Once Run Anywhere", "Write Online Run Anytime", "Write Once Read All"], "correct": 1},
	{"text": "Which tool compiles Java source code?", "answers": ["javac", "jar", "jre", "java"], "correct": 0},
	{"text": "Which component runs compiled Java bytecode?", "answers": ["Compiler", "IDE", "JVM", "JDK"], "correct": 2},
	{"text": "What is the file extension for compiled Java code?", "answers": [".exe", ".java", ".jar", ".class"], "correct": 3},
	{"text": "What command runs a Java program?", "answers": ["javac", "execute", "java", "runjava"], "correct": 2},
	{"text": "Which Java feature allows portability across platforms?", "answers": ["Machine code", "Binary code", "Bytecode & JVM", "Hardware link"], "correct": 2},
	{"text": "What must every Java program include?", "answers": ["scanner", "main() method", "package", "import"], "correct": 1},
	{"text": "Which IDE is commonly used for Java development?", "answers": ["Chrome", "Notepad", "Eclipse", "NetBeans"], "correct": 2},
	{"text": "What does JDK stand for?", "answers": ["Java Dev Kit", "Java Disk Kit", "Java Debug Kit", "Just Data Key"], "correct": 0},
	{"text": "Which package contains basic Java classes?", "answers": ["java.lang", "java.basic", "system.lang", "java.main"], "correct": 0},
	{"text": "What is the purpose of bytecode?", "answers": ["Store data", "Compile C code", "Run anywhere (JVM)", "Faster speed"], "correct": 2},
	{"text": "What does the 'System.out.println()' statement do?", "answers": ["Display text", "Compile", "Read input", "Stop code"], "correct": 0},
	{"text": "What symbol ends a Java statement?", "answers": [":", ";", ",", "."], "correct": 1}
]
...
func wrong():
	...
	monster_sprite.play("ATTACKm1")
	await get_tree().create_timer(0.25).timeout
	shoot_virus()
	await get_tree().create_timer(1.5).timeout
	if not quiz_finished:
		monster_sprite.play("IDLEm1")
...
func hit_monster():
	...
	monster_sprite.play("HITm1")
	flash(monster_sprite)
	await get_tree().create_timer(0.5).timeout
	
	if GameState.virus_health <= 0:
		monster_sprite.play("DEADm1")
