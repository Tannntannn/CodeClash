...
func _ready():
	...
	if drag_drop_state:
		...
		drag_drop_state.set_lesson("Lesson 3")
	
	# Initialize blocks for Lesson 3
	correctly_placed_blocks["intL3button"] = false
	correctly_placed_blocks["doubletotalbbuttonL3"] = false
	correctly_placed_blocks["ScannerbuttonL3"] = false
	correctly_placed_blocks["doublesharebuttonL3"] = false
	correctly_placed_blocks["totalbuttonL3"] = false
...
func start_countdown():
	game_timer.start()
	print("Lesson 3 started! Timer counting down...")
...
func _on_hint_button_pressed():
	...
	var block_to_zone = {
		"intL3button": {"zone": "intL3", "text": "int"},
		"doubletotalbuttonL3": {"zone": "doubletotalL3", "text": "double total"},
		"ScannerbuttonL3": {"zone": "ScannerL3", "text": "Scanner sc = new Scanner(System.in);"},
		"doublesharebuttonL3": {"zone": "doubleshareL3", "text": "double share"},
		"totalbuttonL3": {"zone": "totalL3", "text": "total"}
	}
...
func find_node_by_name(node_name: String):
	var possible_paths = [
		...
		"Panel/Panel/ScrollContainer/Panel/" + node_name,
	]
...
func reset_all_button_colors():
	reset_button_color("intL3button")
	reset_button_color("doubletotalbbuttonL3") 
	reset_button_color("ScannerbuttonL3")
	reset_button_color("doublesharebuttonL3")
	reset_button_color("totalbuttonL3")
...
func submit_score_to_android():
	print("🎯 Lesson3: Submitting score to Android - Score:", current_score)
	
	# Get the AppPlugin instance
	var app_plugin = Engine.get_singleton("AppPlugin")
	if app_plugin:
		print("🎯 Lesson3: Calling AppPlugin.submitScore()")
		app_plugin.submitScore(current_score, 1)  # 1 attempt for drag and drop
	else:
		print("❌ Lesson3: AppPlugin not found!")
