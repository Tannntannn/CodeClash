...
var total_blocks = 5  # You have 4 buttons in Lesson 5
...
func _ready():
	...
	if drag_drop_state:
		...
		drag_drop_state.set_lesson("Lesson 5")
	
	# Initialize Lesson 5 blocks
	correctly_placed_blocks["RandombuttonL5"] = false
	correctly_placed_blocks["RandomrandbuttonL5"] = false
	correctly_placed_blocks["numberbuttonL5"] = false
	correctly_placed_blocks["10buttonL5"] = false
	correctly_placed_blocks["1-10buttonL5"] = false
...
func _on_hint_button_pressed():
	...
	var block_to_zone = {
		"RandombuttonL5": {"zone": "RandomL5", "text": "Random"},
		"RandomrandbuttonL5": {"zone": "RandomrandL5", "text": "Random rand"},
		"numberbuttonL5": {"zone": "numberL5", "text": "number"},
		"randnextintbuttonL5": {"zone": "randnextintL5", "text": "rand.nextInt"},
		"1-10buttonL5": {"zone": "1-10panelL5", "text": "1-10"}
	}
...
func start_countdown():
	game_timer.start()
	print("Lesson 5 started! Timer counting down...")
...
func reset_all_button_colors():
	reset_button_color("RandomrandbuttonL5")
	reset_button_color("RandombuttonL5") 
	reset_button_color("numberbuttonL5")
	reset_button_color("10buttonL5")
	reset_button_color("1-10buttonL5")
...
func puzzle_completed():
	...
	var success_scene = preload("res://Lesson 5/ProlemSolvedL5.tscn")
...
func mistakes_limit_reached():
	...
	var retry_scene = preload("res://Lesson 5/RetryLesson5.tscn")
...
func submit_score_to_android():
	print("🎯 Lesson5: Submitting score to Android - Score:", current_score)
	
	# Get the AppPlugin instance
	var app_plugin = Engine.get_singleton("AppPlugin")
	if app_plugin:
		print("🎯 Lesson5: Calling AppPlugin.submitScore()")
		app_plugin.submitScore(current_score, 1)  # 1 attempt for drag and drop
	else:
		print("❌ Lesson5: AppPlugin not found!")
